...
// End Cross Module References
...
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UClass_ALaser_Statics::Class_MetaDataParams[] = {
		{ "IncludePath", "Laser.h" },
	...
	template<> LIDAR_API UClass* StaticClass<ALaser>()
	{
		return ALaser::StaticClass();
	}
	DEFINE_VTABLE_PTR_HELPER_CTOR(ALaser);
	struct Z_CompiledInDeferFile_FID_LiDAR_Source_LiDAR_Laser_h_Statics
	{
		static const FClassRegisterCompiledInInfo ClassInfo[];
	};
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_LiDAR_Source_LiDAR_Laser_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_ALaser, ALaser::StaticClass, TEXT("ALaser"), &Z_Registration_Info_UClass_ALaser, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(ALaser), 4056467057U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_LiDAR_Source_LiDAR_Laser_h_2031849072(TEXT("/Script/LiDAR"),
